...
const getAdminRoutes=()=>{
  ...
  const manageRoutes={
    name:'Manage',
    to:'/schoolAdmin/manage',
    icon: 'copy',
    children: [
      {to:'schoolAdmin/manage/school', name:'School', children:[
        { to: '/schoolAdmin/manage/school/importStudent', name: 'Import Students' },
        { to: '/schoolAdmin/manage/school/manageStudents', name: 'Manage Students' },
        { to: '/schoolAdmin/manage/school/billing', name: 'Manage Application' }
      ]},
      {to:'schoolAdmin/manage/meals', name:'Meals', children:[
        { to: '/schoolAdmin/manage/meals/activity', name: 'Create Menu' },
        { to: '/schoolAdmin/manage/meals/associations', name: "View Menu's" },
        { to: '/schoolAdmin/manage/meals/billing', name: 'Menu Management' }
      ]},      
    ]
  }
  return [homeRoutes,manageRoutes]
}
const getSuperAdminRoutes=()=>{
 ...
 const manageRoutes={
   name:'Manage School',
   to:'/SuperAdmin/manageSchool',
   icon: 'copy',
   children: [
     {to:'/SuperAdmin/manageSchool/schools', name:'Schools'},
     {to:'/SuperAdmin/manageSchool/manageSchools', name:'Manage Schools'}     
   ]
 }
 return [homeRoutes,manageRoutes]
}
