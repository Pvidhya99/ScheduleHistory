...
export const ParentContext = createContext({ studentsListData: [],pageTitle :"" });

export const orderMealContext = createContext({ selectedItems:{} ,previewOrder : false,count:0});
