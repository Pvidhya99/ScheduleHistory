...
const DailySpendLimitComponent = ({title})=>{
    ...
    const {stateData,enableEdit,saveChanges,textHandler} = useSpendingLimit({index,schoolId})
...
export default DailySpendLimitComponent